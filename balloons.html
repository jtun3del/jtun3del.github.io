...
<head>
    ...
    <!-- google font -->
    <link href="https://fonts.googleapis.com/css2?family=Londrina+Shadow&family=Questrial&display=swap&display=swap"
        rel="stylesheet">
    <!-- animate css -->
...
<body>
    <div class="container animate__animated animate__flash">
        <h1 class="greeting animate__animated animate__heartBeat" id="happybirthday">Happy Birthday!</h1>
        <hr />
        ...
        <form role="form">
            <div class="row">
                <div class="col">
                    ...
                    <div class="card mt-4">
                        <div class="card-body" id="checkbox-card">
    ...
    <div class="toast-container position-fixed bottom-0 end-0 p-3">
        <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
            <div class="toast-header">
                <strong class="me-auto" id="product">No balloons </strong>
                
                <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
            <div class="toast-body" id= "code">
                You have selected no balloons try again.
            </div>
        </div>
    </div>
</body>
